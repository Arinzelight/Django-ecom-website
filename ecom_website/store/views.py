...
def updateItem(request):
    try:
        ...
        productId = data.get('productId')  # Use get() to handle missing key gracefully
...
def processOrder(request):
    ...
    if request.user.is_authenticated:
        customer = request.user.customer
        order, created = Order.objects.get_or_create(customer=customer, complete=False)  # Unpack the tuple 
